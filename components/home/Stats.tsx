...
//       <div className="absolute w-[1440px] h-[252px] left-1/2 -translate-x-1/2 top-[1829px] flex flex-col items-start gap-[48px] px-[124px] pt-[80px]">
//         <div className="grid grid-cols-4 gap-[32px] w-[1192px] h-[104px] flex-none self-stretch">
//           {stats.map((s) => (
//             <div
//               key={s.label}
//               className="w-[274px] h-[104px] flex flex-col gap-[8px]"
//             >
//               <div className="relative w-[274px] h-[72px] flex-none self-stretch">
//                 <div
//                   className={`${albertSans.className} absolute w-[194px] h-[72px] left-[40.64px] top-[0.5px] font-medium text-[76px] leading-[72px] tracking-[-3px] text-center text-[#F05D28]`}
//                 >
//                   {s.value}
//                 </div>
//               </div>
//               <div className="relative w-[274px] h-[24px] flex-none self-stretch order-1">
//                 <div
//                   className={`${albertSans.className} absolute ${s.labelWidth} h-[24px] ${s.labelLeft} top-[-0.5px] font-normal text-[16px] leading-[24px] tracking-[-0.3125px] text-center text-[#444444]/60`}
//                 >
//                   {s.label}
//                 </div>
//               </div>
