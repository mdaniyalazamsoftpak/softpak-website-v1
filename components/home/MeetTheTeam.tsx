...
export default function MeetTheTeam() {
  return (
    <section className="relative w-full h-[572px] bg-brand-cardGray">
        ...
        <div className="absolute w-[599px] h-[373px] left-0 top-0 rounded-none">
          ...
          <div className="absolute w-[568px] h-[288.78px] top-[42.28px] left-[640px] opacity-100">
            <div className="w-[568px] h-[61.59px] opacity-100">
              <h2
                className={`${albertSans.className} absolute w-[321px] h-[62px] left-0 top-[0.5px] font-medium text-[48px] leading-[62px] text-center tracking-[-1.09922px] text-brand-darker`}
              >
                Meet the Team
              </h2>
            </div>
            <div className="absolute w-[568px] h-[115.19px] top-[85.59px] opacity-100">
              <p
                className={`${albertSans.className} absolute w-[567px] h-[75px] left-0 top-[0.5px] font-normal text-[18px] leading-[25px] tracking-[-0.439453px] text-brand-darker/60`}
              >
            ...
            <Link
              href="#"
              className="absolute w-[205px] h-[56px] left-0 top-[232.72px] bg-brand-dark rounded-[14px] flex items-center justify-center"
            >
